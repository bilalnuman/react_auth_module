        ...
        <div className='w-screen h-screen flex justify-center items-center flex-col'>
            ...
            <div className='mt-4'>
                <div className='flex flex-col'>
                    <button className='border p-2' onClick={() => setFilter('brands', 'watch')}>Brand: Watch</button>
                ...
                <button onClick={() => { clearFilters(["page"]); searchRef.current?.clear(); navigate('/searchInput') }}>clear</button>
